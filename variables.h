...
extern bool tempenv_assign_error;
extern bool array_needs_making;
...
extern char **add_or_supercede_exported_var (const char *, int);
...
extern VAR_CONTEXT *new_var_context (const char *, int);
extern void dispose_var_context (VAR_CONTEXT *);
extern VAR_CONTEXT *push_var_context (const char *, int, HASH_TABLE *);
extern void pop_var_context (void);
extern VAR_CONTEXT *push_scope (int, HASH_TABLE *);
extern int pop_scope (int);
...
extern void non_unsettable (const char *);
extern void dispose_variable (void *);
...
extern void set_var_read_only (const char *);
extern void set_func_read_only (const char *);
extern void set_var_auto_export (const char *);
extern void set_func_auto_export (const char *);

extern void sort_variables (SHELL_VAR **);

extern int chkexport (const char *);
extern void maybe_make_export_env (void);
extern void update_export_env_inplace (const char *, int, const char *);
extern void put_command_name_into_env (const char *);
extern void put_gnu_argv_flags_into_env (intmax_t, const char *);
