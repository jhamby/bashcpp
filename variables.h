...
constexpr int VC_HASLOCAL =		0x01;
constexpr int VC_HASTMPVAR =	0x02;
constexpr int VC_FUNCENV =		0x04;	/* also function if name != NULL */
constexpr int VC_BLTNENV =		0x08;	/* builtin_env */
constexpr int VC_TEMPENV =		0x10;	/* temporary_env */
constexpr int VC_TEMPFLAGS =	(VC_FUNCENV | VC_BLTNENV | VC_TEMPENV);
...
constexpr int att_exported =	0x0000001;	/* export to environment */
constexpr int att_readonly =	0x0000002;	/* cannot change */
constexpr int att_array =		0x0000004;	/* value is an array */
constexpr int att_function =	0x0000008;	/* value is a function */
constexpr int att_integer =		0x0000010;	/* internal representation is int */
constexpr int att_local =		0x0000020;	/* variable is local to a function */
constexpr int att_assoc =		0x0000040;	/* variable is an associative array */
constexpr int att_trace =		0x0000080;	/* function is traced with DEBUG trap */
constexpr int att_uppercase =	0x0000100;	/* word converted to uppercase on assignment */
constexpr int att_lowercase =	0x0000200;	/* word converted to lowercase on assignment */
constexpr int att_capcase =		0x0000400;	/* word capitalized on assignment */
constexpr int att_nameref =		0x0000800;	/* word is a name reference */

constexpr int user_attrs =	(att_exported | att_readonly | att_integer | att_local
			 | att_trace | att_uppercase | att_lowercase | att_capcase
			 | att_nameref );

constexpr int attmask_user =	0x0000fff;

/* Internal attributes used for bookkeeping */
constexpr int att_invisible =	0x0001000;	/* cannot see */
constexpr int att_nounset =		0x0002000;	/* cannot unset */
constexpr int att_noassign =	0x0004000;	/* assignment not allowed */
constexpr int att_imported =	0x0008000;	/* came from environment */
constexpr int att_special =		0x0010000;	/* requires special handling */
constexpr int att_nofree =		0x0020000;	/* do not free value on unset */
constexpr int att_regenerate =	0x0040000;	/* regenerate when exported */

constexpr int attmask_int =		0x00ff000;

/* Internal attributes used for variable scoping. */
constexpr int att_tempvar =		0x0100000;	/* variable came from the temp environment */
constexpr int att_propagate =	0x0200000;	/* propagate to previous scope */

constexpr int attmask_scope =	0x0f00000;
...
public:
  ...
  typedef SHELL_VAR *sh_var_assign_func_t (SHELL_VAR *, const char *, arrayind_t, const char *);
