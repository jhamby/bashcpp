...
#include <sys/param.h>
    ...
    || defined __DragonFly__ /* FreeBSD, NetBSD, OpenBSD, DragonFly, MacOS X, \
                                Cygwin */
...
#undef fpurge
  ...
  /* Most systems provide FILE as a struct and the necessary bitmask in
    ...
    || __GNU_LIBRARY__ == 1 /* GNU libc, BeOS, Haiku, Linux libc5 */
  ...
  fp_->_r = 0;
  fp_->_w = ((fp_->_flags & (__SLBF | __SNBF | __SRD))
...
#elif defined _IOERR                                                          \
    || defined                                                                \
        __TANDEM /* AIX, HP-UX, IRIX, OSF/1, Solaris, OpenServer, mingw */
  fp->_ptr = fp->_base;
  if (fp->_ptr != NULL)
    fp->_cnt = 0;
  return 0;
...
#else
#warning                                                                      \
    "Please port gnulib fpurge.c to your platform! Look at the definitions of fflush, setvbuf and ungetc on your system, then report this to bug-gnulib."
  return 0;
#endif
