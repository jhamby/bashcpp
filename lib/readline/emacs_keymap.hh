...
Readline::new_emacs_standard_keymap ()
{
  ...
  ret[i++]
      = KME (ISFUNC, &Readline::rl_reverse_search_history); /* Control-r */
  ret[i++]
      = KME (ISFUNC, &Readline::rl_forward_search_history); /* Control-s */
...
Readline::new_emacs_meta_keymap ()
{
  ...
  ret[i++]
      = KME (ISFUNC, &Readline::rl_backward_kill_word);   /* Meta-Control-h */
  ...
  i++; /* zero-init */                             /* Meta-Control-\ */
  ret[i++]
      = KME (ISFUNC, &Readline::rl_backward_char_search); /* Meta-Control-] */
  i++; /* zero-init */                                    /* Meta-Control-^ */
...
Readline::new_emacs_ctlx_keymap ()
{
  ...
  ret[i++]
      = KME (ISFUNC, &Readline::rl_exchange_point_and_mark); /* Control-x */
