  ...
  try
    {
      ...
      do
        {
          ...
          /* States that can occur while in state VIMOTION have to be checked
          ...
          else if (RL_ISSTATE (RL_STATE_VIMOTION))
            {
              ...
              /* Should handle everything, including cleanup, numeric
                 arguments, and turning off RL_STATE_VIMOTION */
          ...
          else if (_rl_callback_func)
            {
              /* This allows functions that simply need to read an additional
                 ...
                 passed to the registering function and space for any
      ...
      while (rl_pending_input || _rl_pushed_input_available ()
